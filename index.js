...
(function (root, factory) {
    ...
    return function CustomEventPolyfill() {
      (function (undefined) {
        if (!((function (global) {
          ...
          (function () {
            ...
            window.Event = Window.prototype.Event = function Event(type, eventInitDict) {
              ...
              if ('createEvent' in document) {
                ...
                var cancelable = eventInitDict && eventInitDict.cancelable !== undefined ?
              ...
              event.cancelable =
                eventInitDict && eventInitDict.cancelable !== undefined ? eventInitDict.cancelable :
                  false;
